...
%-----------PROJECTS (DEPRECATED) (BECAUSE FONT WAS SMALL)-----------------
%\section{Projects}
 % \resumeSubHeadingListStart
  %  \resumeSubItem{Automated Gait Generation for Simulated Machines{\em (Ongoing)}}
   %   {Project to generate gait for simulated machines with no external input using only Deep Reinforcement Learning.}
    ...
    %\resumeSubItem{TypeRacer Terminal}
      %{A terminal application which allows users to practise, compete, and improve typing speed and accuracy. Written in Python using the ncurses library.}
  %\resumeSubHeadingListEnd
